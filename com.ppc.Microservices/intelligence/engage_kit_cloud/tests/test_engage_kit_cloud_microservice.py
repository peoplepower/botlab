...
from signals.engage_kit_cloud import CloudMessageStatus  # type: ignore
...
class TestEngageKitCloudMicroservice(unittest.TestCase):
    def test_engage_kit_cloud_microservice(self):
        ...
        mut = location_object.intelligence_modules[
            "intelligence.engage_kit_cloud.location_engage_kit_cloud_microservice"
        ]
        ...
        phrases = [
            {"text": message.priority_phrase(), "scores": [0.1, 0.2, 0.3]}
