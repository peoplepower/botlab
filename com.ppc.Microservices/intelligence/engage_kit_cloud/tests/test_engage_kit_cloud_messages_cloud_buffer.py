    ...
    def test_engage_kit_cloud_messages_cloud_buffer_message_scheduling_future(self):
        ...
        messages = [
            BotMessage(
                ...
                topic_id="welcome",
                app_instance_id=1,
                content_key="Message 1",
                content_text=None,
                creation_time=current_timestamp_ms,
                max_delivery_time=current_timestamp_ms + utilities.ONE_DAY_MS,
                delivery_day_time=message_1_delivery_date_s,
                time_to_live=3600,
                delivery_time=None,
                lang=None,
                schedule=None,
            ...
            BotMessage(
                ...
                topic_id="welcome",
                app_instance_id=1,
                content_key="Message 2",
                content_text=None,
                creation_time=current_timestamp_ms,
                max_delivery_time=current_timestamp_ms + utilities.ONE_DAY_MS,
                delivery_day_time=message_2_delivery_date_s,
                time_to_live=3600,
                delivery_time=None,
                lang=None,
                schedule=None,
            ...
            BotMessage(
                ...
                topic_id="welcome",
                app_instance_id=1,
                content_key="Message 3",
                content_text=None,
                creation_time=current_timestamp_ms,
                max_delivery_time=current_timestamp_ms + utilities.ONE_DAY_MS,
                delivery_day_time=message_3_delivery_date_s,
                time_to_live=3600,
                delivery_time=None,
                lang=None,
                schedule=None,
            ...
            BotMessage(
                ...
                creation_time=current_timestamp_ms,
                max_delivery_time=current_timestamp_ms + utilities.ONE_DAY_MS,
                delivery_day_time=message_4_delivery_date_s,
                time_to_live=3600,
                delivery_time=None,
                lang=None,
                schedule=None,
        ...
        scheduled_messages = mut.get_scheduled_messages_with_adjusted_delivery_times(
            botengine,
        ...
        assert scheduled_messages == [
            BotUpdatedMessage(
                messageId=1,
                status=2,
                delivery_date=f"{(midnight_timestamp_s + message_1_delivery_date_s) * 1000}",
                schedule=None,
            ),
            BotUpdatedMessage(
                messageId=2,
                status=2,
                delivery_date=f"{(midnight_timestamp_s + message_2_delivery_date_s) * 1000}",
                schedule=None,
            ),
            BotUpdatedMessage(
                messageId=3,
                status=2,
                delivery_date=f"{(midnight_timestamp_s + message_3_delivery_date_s) * 1000}",
                schedule=None,
            ),
            BotUpdatedMessage(
                messageId=4,
                status=2,
                delivery_date=f"{(midnight_timestamp_s + message_4_delivery_date_s + CLOUD_SCHEDULE_INTERVAL_S) * 1000}",
                schedule=None,
            ),
        ]
    ...
    def test_engage_kit_cloud_messages_cloud_buffer_message_scheduling_past(self):
        ...
        assert scheduled_messages == [
            BotUpdatedMessage(
                messageId=1,
                status=2,
                delivery_date=f"{int(current_timestamp_ms + (CLOUD_SCHEDULE_INTERVAL_S * 1000))}",
                schedule=None,
            ),
            BotUpdatedMessage(
                messageId=2,
                status=2,
                delivery_date=f"{int(current_timestamp_ms + (CLOUD_SCHEDULE_INTERVAL_S * 2000))}",
                schedule=None,
            ),
            BotUpdatedMessage(
                messageId=3,
                status=2,
                delivery_date=f"{int(current_timestamp_ms + (CLOUD_SCHEDULE_INTERVAL_S * 3000))}",
                schedule=None,
            ),
        ]
