...
# Data Stream Address
DATASTREAM_ADDRESS = "zendesk_status"

# Data Stream Content
DATASTREAM_CONTENT = {
    "user_id": 90381, # User ID to update status for (used for testing, real implementation pulls from trigger input key "userId")
    "status": -1  # -1 = suspended, 0 = not found, 1 = released
}
