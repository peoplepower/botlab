...
DATASTREAM_ADDRESS = "organization_surveys_post_notification"

DATASTREAM_CONTENT = {
    # Key of the survey to answer
    "survey_key": "successful_aging_connections", # Required

    # Answer a survey for a specific user
    "user_id": 90380,

    # Answer a survey for users with this role on the location
    # "role": 1,

    # Send the email directly to the user
    "send_to_user": True,

    # Send the notification to organization notification user with this category
